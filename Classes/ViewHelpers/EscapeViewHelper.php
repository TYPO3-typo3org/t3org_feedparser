...
/**
 * Extension of Fluids ViewHelper that is not able to escape 
 * objects before they are converted to strings...
 *
 * @license http://www.gnu.org/licenses/lgpl.html GNU Lesser General Public License, version 3 or later
 * @api
 */
class Tx_T3orgFeedparser_ViewHelpers_EscapeViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
